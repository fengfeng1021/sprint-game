            ...
            <div className="w-full max-w-md bg-[#1c1917] border border-[#fbbf24]/30 p-8 rounded-2xl shadow-2xl relative z-10 animate-in fade-in zoom-in duration-300">
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input 
                                ...
                                className="w-full bg-black/50 border border-white/10 rounded-lg py-3 pl-10 pr-4 text-white focus:border-[#fbbf24] outline-none transition-colors" 
                            />
                        </div>
                    </div>
                    <div>
                    ...
                    <button 
                        ...
                        disabled={loading} 
                        className="w-full bg-gradient-to-r from-[#b45309] to-[#fbbf24] text-black font-bold py-3 rounded-lg hover:brightness-110 transition-all flex items-center justify-center gap-2 shadow-lg active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
...
export default function App() {
    ...
    const handleLogin = async (id, pass) => {
        ...
        try {
            ...
            console.error(e); 
            alert("登入錯誤 (請檢查 Firebase 設定): " + e.message); 
        }
        setLoading(false);
    };
